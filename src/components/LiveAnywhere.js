...
export default function LiveAnywhere() {
  const [data, setData] = useState([
    ...
    { image: "adventure.webp", title: "Great adventure" },
    { image: "experience.webp", title: "Awesome Experience" },
    { image: "unique.webp", title: "My Unique Hut" },
    { image: "faisalabad.webp", title: "Swimming Pool" },
  ]);
  return (
